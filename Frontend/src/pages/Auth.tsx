              ...
              {isForgotPassword ? (
                ...
                >
                  ...
                  {isResetSuccess ? (
                    <motion.div
                      variants={itemVariants}
                      className={`p-4 border rounded-xl text-center space-y-3 transition-colors duration-700 bg-background/50 border-border`}
                    >
                    ...
                    <>
                      ...
                      >
                        <label className="text-[10px] font-bold uppercase tracking-widest mb-1 transition-colors duration-700 text-muted-foreground">
                          EMAIL
                        </label>
                ...
                >
                  ...
                  <motion.div
                    variants={itemVariants}
                    className="flex justify-end mt-[-2px]"
                  >
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  >
                    <div className="flex items-center w-full mb-4 opacity-60">
                      ...
                      <span className="px-3 text-[10px] uppercase tracking-wider font-semibold transition-colors duration-700 text-muted-foreground">
                        or continue with
                      </span>
                      <div className="flex-1 h-[1px] transition-colors duration-700 bg-border"></div>
                    </div>
                  ...
                  <motion.p
                    variants={itemVariants}
                    className="text-center text-[10px] mt-4 leading-relaxed transition-colors duration-700 text-muted-foreground"
                  >
                    By continuing, you agree to our{" "}
                    <span className="text-accent cursor-pointer hover:underline transition-colors">
                      Terms
                    </span>{" "}
                    and{" "}
                    <span className="text-accent cursor-pointer hover:underline transition-colors">
