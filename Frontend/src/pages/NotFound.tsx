...
export default function NotFound() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center p-6 text-center font-sans bg-background text-foreground relative overflow-hidden">
      {/* Dynamic Background */}
