        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar">
          ...
          <div className="flex items-center justify-end gap-2.5 pt-4 border-t border-[#F5F0E8] select-none mt-2 shrink-0">
            <button
              ...
              disabled={isSubmitting}
              onClick={onClose}
              className={`rounded-full border border-[#2B2A4C] px-6 py-2.5 text-xs font-bold text-[#2B2A4C] transition-transform duration-200 bg-white ${
                isSubmitting ? "opacity-50 cursor-not-allowed" : "hover:scale-[1.02] cursor-pointer"
              }`}
            >
              Cancel
            </button>
